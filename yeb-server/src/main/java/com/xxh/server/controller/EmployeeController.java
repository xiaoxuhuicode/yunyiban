...
public class EmployeeController {
    ...
    public void exportEmployee(HttpServletResponse response){
        List<Employee> list = employeeService.getEmployee(null);//和单个查询员工复用方法
    ...
    public RespBean importEmployee(MultipartFile file){
        ...
        try {
            ...
            list.forEach(employee -> {
                //利用重写hashcode和equals方法查询一次数据库
                employee.setNationId(nationList.get(nationList.indexOf(new Nation(employee.getNation().getName()))).getId());//民族ID
